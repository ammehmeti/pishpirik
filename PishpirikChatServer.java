...
public class PishpirikChatServer {
	...
	private static String mesazhiLojes = "";
	...
	public static void main(String[] args) {
		...
		shperndajLetrat();
		try {
			PishpirikChatServer cs = new PishpirikChatServer();

		} catch (ArrayIndexOutOfBoundsException ae) {
			JOptionPane.showMessageDialog(null, "Ju lutem jepni portion", "KUJDES", JOptionPane.INFORMATION_MESSAGE);
			System.exit(-1);
		}
	}
	...
	public String ktheMesazhinLojes() {
		if (lojtari.size() % 2 == 1) {
			// mesazhiLojes="Ne pritje te kundershtarit....feels good!!!";
			return "Ne pritje te kundershtarit...";
		} else {
			// mesazhiLojes="Tani loja fillon~!!!";
